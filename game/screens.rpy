...
screen nastpanel:
    hbox:
        ...
        ysize 50
        add "smail.png"
        text "[nastroy]" color "#adff2f"

screen daytpanel:
    frame:
        padding (10, 10) # отступы от рамки фрейма
        xalign 0.5
        yalign 0.01
        xsize 80
        ysize 65
        vbox:
            xsize 60
            ysize 50
            add "sun.png" xalign 0.5
            null height 10
            text "[theweekday]" xalign 0.5
